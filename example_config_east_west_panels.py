...
# Example covering 2 panels on a west-facing balcony and 2 on an east-facing balcany
...
SIM_PARAM1_NAME = "Tilt Panel 1"
SIM_PARAM2_NAME = "Tilt Panel 2"
SIM_PARAM1 = np.arange(35, 45, 1)
SIM_PARAM2 = np.arange(35, 45, 1)
